...
const TableIOS = forwardRef<HTMLDivElement, TableIOSProps>(
...
const TableIOSSection = forwardRef<HTMLDivElement, TableIOSSectionProps>(
...
const TableIOSRow = forwardRef<HTMLDivElement, TableIOSRowProps>(
  ({ className, label, value, icon, chevron = false, onClick, destructive = false, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        onClick={onClick}
...
const TableIOSToggleRow = forwardRef<HTMLDivElement, TableIOSToggleRowProps>(
  ({ label, icon, checked, onToggle, destructive, className, ...props }, ref) => {
    return (
      <TableIOSRow
        ref={ref}
        label={label}
